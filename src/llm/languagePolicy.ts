...
export const GATE_OUTPUT_LANGUAGE_POLICY =
  "Use only English, Russian, or Uzbek (Latin or Cyrillic) for question and quick_replies. Never Urdu, Arabic script, Persian, Hindi, or other scripts.";

/** Persona / terminal notice rephrasing. */
export const PERSONA_OUTPUT_LANGUAGE_POLICY =
